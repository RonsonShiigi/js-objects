...
console.log('puchase date= ' + orders[i].date);
...
var sumObjResult = 'undefined';

function objectAddition(obj){

    
    sumObj.result = obj.a + obj.b;
    
  
return sumObjResult = sumObj.result
...
return console.log( obj.a + ' +  ' + obj.b + ' +  ' + ' = ' + obj.output)
...
if(obj.automaticTransmission === true){
    return 'Auto Transmission is good to go'
}
else{
    return 'Driving Stick!' 
}
